...
for(var j=0;j<searchout.length;j++){
  var mapgetid = searchout[j].RentFullStruct.Id;
 ...
 var bhk =searchout[j].RentFullStruct.Bhk +" BHK";
 ...
 var geturl ="individual_page.html?Id="+mapgetid
