(function( window, $, undefined ) {
	...
	$.elastislide.defaults 		= {
		...
		current		: 0,	// index of the current item
							// when we resize the window, the carousel11 will make sure this item is visible 
	...
	$.elastislide.prototype 	= {
		_init 				: function( options ) {
			...
			this.$escarousel11	= this.$slider.parent();
		...
		_configure			: function() {
			...
			// the ul's parent's (div.es-carousel11) width is the "visible" width
			this.visibleWidth	= this.$escarousel11.width();
		...
		_setCurrentValues	: function() {
			...
			// the ul parent's (div.es-carousel11) width is the "visible" width
			this.visibleWidth	= this.$escarousel11.width();
		...
		add					: function( $newelems, callback ) {
			...
			// adds new items to the carousel11
