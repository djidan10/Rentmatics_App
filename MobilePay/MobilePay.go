...
//const PROD_URL = "https://www.instamojo.com/integrations/android/redirect/"
//const TEST_URL = "https://test.instamojo.com/integrations/android/redirect/"
...
func CreateOrderTokens(env string) ([]byte, error) {
	...
	if err != nil {
		fmt.Println("error in  http.NewRequest")
		return []byte(""), err
	}
	...
	if err != nil {
		fmt.Println("error in TWclient.DoO")
	...
	if err != nil {
		fmt.Println("error in ioutil.ReadAll ", string(data))

		return []byte(""), err
	}

	fmt.Println("ioutil.ReadAll ", string(data))
	...
	if err = json.Unmarshal(data, &jsonResponse); err != nil {
		...
		fmt.Println("error json.Unmarshal ", jsonResponse)
